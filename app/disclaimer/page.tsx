...
const sections = [
  ...
  },
  {
    number: "03",
    title: "内容仅供参考",
    content: <ul><li>分数线、报录数据、招生名额和复试安排整理自公开渠道与考生资料，可能随时间变化或存在误差，请以官方最新信息为准。</li><li>经验文章只代表分享者在特定年份的个人经历，不构成报考建议、结果承诺或录取保证。</li><li>培养地点、住宿、补助、实习和导师相关信息可能调整，入学与选择导师前请重新确认。</li><li>复试题目均为考生回忆或二次整理，不是官方试卷，也不用于预测下一年度命题。</li></ul>,
  },
  {
    number: "04",
    title: "外部链接与群聊",
