...
test("server-renders the complete 2026 annual report", async () => {
  ...
  assert.match(html, /87<small> 人/);
  assert.match(html, /79<small> 人/);
  assert.match(html, /8<small> 人/);
  assert.match(html, /大厂/);
  assert.match(html, /50 人/);
  assert.match(html, /公务员与体制内/);
  assert.match(html, /20 人/);
  assert.match(html, /读博深造/);
